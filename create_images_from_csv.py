...
csv_File_Path = "./dataset/archive/A_Z Handwritten Data/A_Z Handwritten Data.csv"

count = 1
last_digit_Name =  None

image_Folder_Path = "./dataset/images_dataset"
...
with open(csv_File_Path, newline='') as csvfile:
    ...
    for row in reader:
        ...
        new_image = Image.fromarray(image_array.astype('float32'))
